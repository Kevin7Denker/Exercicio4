...
public class FabricaConexoes {
   ...
   private static String URL_DB = "http://wagnerweinert.com.br/";
   private static String DB_NAME = "info21_kevin";
   private static String USERNAME = "info21_kevin";
   private static String PASSWORD = "info21_kevin";
